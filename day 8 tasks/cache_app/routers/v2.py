...
from utils.dependencies import fetch_user_from_db,inproc_rate_limiter
...
async def get_user_v1(user_id: int,_rl: None = Depends(inproc_rate_limiter)):
...
@routerv2.post("/users/v2", response_model=UserOutV2, status_code=201)
